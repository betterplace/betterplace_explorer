...
export default class VolunteeringInfoBubble extends InfoBubble {
  ...
  panToView() {
    ...
    var neededTop    = bubbleHeight  + padding - anchorPos.y,
        neededRight  = bubbleWidth/2 + padding - (mapWidth  - anchorPos.x),
        neededBottom =                 padding - (mapHeight - anchorPos.y),
        neededLeft   = bubbleWidth/2 + padding - anchorPos.x

    var deltaX = 0,
        deltaY = 0

    if      (neededLeft   > 0) deltaX = -neededLeft
    else if (neededRight  > 0) deltaX =  neededRight

    if      (neededTop    > 0) deltaY = -neededTop
    else if (neededBottom > 0) deltaY =  neededBottom
